...
I am a passionate software engineer with a strong background in backend development, distributed systems, and competitive programming. Currently, I am engineering core features for **Odoo's Accounting suite**. Previously, I worked on high-scale systems at **Noon** and have a strong foundation in algorithms and data structures.
...
I actively participate in algorithmic contests and have solved **3000+ problems** across various platforms.

- 🥉 **Bronze Medal (14th Place)** - Africa and Arab Collegiate Programming Championship 2024 (Qualified for ICPC).
- 🏅 **5th Place in Egypt** - IEEEXtreme 18.0 2024 (27th Worldwide).
...
_Django, Rasa, ElectronJS_
- Architected a modular backend for script execution and marketplace services.
- Implemented real-time bi-directional communication using WebSockets (Daphne, Redis).
